...
def main():
    ...
    if st.button("Finish Presentation"):
        with st.expander("Imagen", expanded=True):
            image_path_ = "https://storage.googleapis.com/methane_source/foto.png"
            ...
            st.markdown(f'<img src="{image_path_}" class="moving-image" style="max-width: 600px;">', unsafe_allow_html=True)
